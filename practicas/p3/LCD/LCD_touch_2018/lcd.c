...
*********************************************************************************************/
void LcdClrRectLcdClrRect(INT16 usLeft, INT16 usTop, INT16 usRight, INT16 usBottom, INT8U ucColor)
{
	INT16 i,k,l,m;
...
void Lcd_Dma_Trans(void)
{
	...
	//Delay(500);
	while(ucZdma0Done);		//wait for DMA finish --- ESPERA ACTIVA, EN VEZ DE APROVECHAR EL RETARDO DEL DMA, SACAR CONCURRENCIA Y MAYOR RENDIMIENTO, MIENTRAS JUEGO COPIA LAS COSAS DEL DMA
}
